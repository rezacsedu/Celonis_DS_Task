...
I wrote a script named [data_util.py]((https://github.com/rezacsedu/Celonis_DS_Task/blob/main/utils/data_util.py)) in NumPy to extract features from the '.txt' files. There are three methods in this script: 
